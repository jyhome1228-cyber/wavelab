...
const commonKeywords=['AESOST TECHNOLOGY','에이소스트 테크놀로지','웹개발','시스템 개발','맞춤형 개발'];

const pages={
  'index.html':{
    path:'/',
    title:'AESOST TECHNOLOGY | 기업 홈페이지·맞춤형 업무 시스템 개발',
    description:'AESOST TECHNOLOGY는 기업 홈페이지, CRM, 관리자 페이지, 고객 포털, 예약·발주·멤버십 등 업무 시스템을 기획·디자인·개발합니다. 실제 일하는 방식을 듣고 맞춰 설계합니다.',
    keywords:['기업 홈페이지 제작','회사 홈페이지 제작','맞춤형 업무 시스템','CRM 개발','관리자 페이지 개발','고객 포털','업무 자동화'],
    schema:'WebSite'
  },
  'about.html':{
    path:'/about.html',
    title:'AESOST TECHNOLOGY 소개 | 웹·시스템 개발 파트너',
    description:'AESOST TECHNOLOGY는 기업과 브랜드의 업무 방식을 이해하고 홈페이지, 관리자, CRM, 포털, 운영 시스템을 기획·UI·개발까지 한 흐름으로 구축합니다.',
    keywords:['AESOST TECHNOLOGY 소개','웹 개발사','시스템 개발사','기업 웹개발','맞춤 개발','UI UX 개발'],
    schema:'AboutPage'
  },
  'services.html':{
    path:'/services.html',
    title:'서비스 | 기업 홈페이지·업무 시스템 개발 | AESOST TECHNOLOGY',
  ...
  'system-solutions.html':{
    ...
    title:'업무 시스템 솔루션 10종 | 인터랙티브 데모 | AESOST TECHNOLOGY',
  ...
  'works.html':{
    path:'/works.html',
    title:'구축 사례 | 웹사이트·CRM·업무 시스템 | AESOST TECHNOLOGY',
    description:'AESOST TECHNOLOGY의 기업 홈페이지, CRM, 관리자 페이지, 대시보드, 고객 포털 등 웹·시스템 구축 사례와 개발 방식을 확인하세요.',
    keywords:['웹사이트 구축 사례','CRM 구축 사례','관리자 페이지 사례','대시보드 개발','업무 시스템 포트폴리오'],
    schema:'CollectionPage'
  },
  'request.html':{
    path:'/request.html',
    title:'프로젝트 문의 | 웹·시스템 개발 상담 | AESOST TECHNOLOGY',
    description:'회사 홈페이지, 관리자 페이지, CRM, 고객 포털, 예약·발주·프로젝트 관리 시스템 등 필요한 개발 범위를 AESOST TECHNOLOGY와 함께 정리해 보세요.',
    keywords:['홈페이지 제작 문의','시스템 개발 문의','CRM 견적','관리자 페이지 견적','맞춤 개발 상담'],
    schema:'ContactPage'
  },
  'solution-solodesk.html':{
    path:'/solution-solodesk.html',
    title:'1인사업자 관리 시스템 SoloDesk | AESOST TECHNOLOGY',
  ...
  'solution-b2b-inquiry.html':{
    ...
    title:'기업 B2B 문의·영업 관리 시스템 | AESOST TECHNOLOGY',
  ...
  'solution-company-cms.html':{
    ...
    title:'기업 홈페이지 CMS·관리자 시스템 | AESOST TECHNOLOGY',
  ...
  'solution-client-portal.html':{
    ...
    title:'고객 프로젝트 공유 포털 시스템 | AESOST TECHNOLOGY',
  ...
  'solution-booking-os.html':{
    ...
    title:'예약·고객·이용권 관리 시스템 Booking OS | AESOST TECHNOLOGY',
  ...
  'solution-vendor-desk.html':{
    ...
    title:'협력사·발주·납기 관리 시스템 Vendor Desk | AESOST TECHNOLOGY',
  ...
  'solution-membership-admin.html':{
    ...
    title:'회원·멤버십·구독 관리 시스템 | AESOST TECHNOLOGY',
  ...
  'solution-support-desk.html':{
    ...
    title:'고객 문의·CS·티켓 관리 시스템 Support Desk | AESOST TECHNOLOGY',
  ...
  'solution-project-room.html':{
    ...
    title:'프로젝트 협업·진행·승인 관리 시스템 Project Room | AESOST TECHNOLOGY',
  ...
  'solution-quote-flow.html':{
    ...
    title:'견적·제안서 자동화 시스템 QuoteFlow | AESOST TECHNOLOGY',
...
function schemaFor(file,meta){
  ...
  const organization={
    '@type':'Organization',name:'AESOST TECHNOLOGY',alternateName:'에이소스트 테크놀로지',url:base,
    logo:`${base}/favicon.svg`,description:pages['index.html'].description
  };
  if(file==='index.html')return {'@context':'https://schema.org','@graph':[organization,{'@type':'WebSite',name:'AESOST TECHNOLOGY',url:base,description:meta.description,inLanguage:'ko-KR'}]};
  ...
  if(meta.schema==='Service')return {'@context':'https://schema.org','@type':'Service',name:'AESOST TECHNOLOGY 웹·시스템 개발 서비스',url:canonical,description:meta.description,provider:organization,areaServed:'KR'};
  return {'@context':'https://schema.org','@type':meta.schema||'WebPage',name:meta.title,url:canonical,description:meta.description,inLanguage:'ko-KR',isPartOf:{'@type':'WebSite',name:'AESOST TECHNOLOGY',url:base}};
}
...
function applyMeta(file,meta){
  ...
  html=setMeta(html,/<meta\s+property=["']og:site_name["'][^>]*>/i,'<meta property="og:site_name" content="AESOST TECHNOLOGY">');
...
console.log(`Applied current AESOST TECHNOLOGY SEO metadata and inquiry widget to ${Object.keys(pages).length} pages.`);
