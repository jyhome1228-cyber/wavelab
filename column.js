...
import { collection, doc, getDoc, getDocs, orderBy, query, where } from 'https://www.gstatic.com/firebasejs/12.16.0/firebase-firestore.js';
...
async function loadColumns(){
  try{
    const snapshot=await getDocs(query(collection(db,'columns'),where('status','==','published'),orderBy('publishedAt','desc')));
