...
hotfix.id='aesost-layout-hotfix';
hotfix.textContent=`
:root{
  --ds-content:1280px!important;
  --ds-wide:1280px!important;
  --ds-label:112px!important;
  --ds-grid-gap:32px!important;
}
...
.solutions-index-page .solution-index-section>.shell,
.solutions-index-page .solution-index-custom>.shell,
.works-page .section.soft>.shell,
.works-page #concept-systems>.shell,
...
.page-hero-grid>div,
.section-head>.section-copy{max-width:840px!important}
.page-title,
.request-intro h1,
.technology-page .technology-hero-copy .page-title,
.solution-detail-page .solution-detail-copy .page-title{
...
.solution-demo-entry h2,
.cta-grid h2{
  font-size:23px!important;
  line-height:1.35!important;
}
.request-section-head h2{font-size:21px!important}
.lead,
...
.services-page .solution-copy p,
.solution-intro-copy>p,
.solution-demo-entry p{
  font-size:14px!important;
  line-height:1.65!important;
}
.page-hero{padding:52px 0!important}
.section{padding:64px 0!important}
.request-page{padding:52px 0 72px!important}
.request-section{padding:40px 0!important}
.solutions-index-page .solution-index-hero{padding:52px 0!important}
.solutions-index-page .solution-index-stats{
...
.solutions-index-page .solution-index-stats b{font-size:17px!important}
.solutions-index-page .solution-index-stats small{font-size:10px!important}
...
@media(max-width:767px){
  :root{--ds-label:1fr!important;--ds-grid-gap:16px!important}
  .shell,
  .page-hero-grid.shell,
  .request-wrap,
  .dev-header .shell,
  ...
  .display,.home-simple .display{font-size:32px!important}
  .section-title{font-size:22px!important}
  .solution-copy h3,
  .solution-intro-copy h2,
  .solution-demo-entry h2,
  .cta-grid h2{font-size:21px!important}
