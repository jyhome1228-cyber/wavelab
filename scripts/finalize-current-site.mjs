...
shell=shell.replace(/site-runtime\.js\?v=[^'"\s)]+/g,'site-runtime.js?v=20260908-3');
...
for(const file of pages){
  ...
  html=html.replace(/dev-shell\.js\?v=[^'"\s<]+/g,'dev-shell.js?v=20260908-5');
...
const required=[
  '에이소스트 (AESOST)','박재영','820-13-02834','인천광역시 서구 원당대로 1039, 9층 915호','부동산업','비주거용 건물 임대업'
];
...
console.log('Finalized current AESOST shell/runtime cache and validated compact business footer.');
