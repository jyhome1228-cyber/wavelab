document.body.classList.add('quote-flow-light');

if(!document.getElementById('quote-flow-light-css')){
  const light=document.createElement('link');
  light.id='quote-flow-light-css';
  light.rel='stylesheet';
  light.href='solution-quote-flow-light.css?v=20260911-1';
...
if(heroVisual){
  heroVisual.src='assets/dev/work-quote-flow-light.svg?v=20260911-1';
}
...
function activate(view){
  ...
  frame.src=`demo/quote-flow/?view=${encodeURIComponent(view)}&guide=1`;
